                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table mb-0">
                                    ...
                                    <tbody>
                                    @forelse ($pazepros as $pazepro)
                                        <tr>
                                            <th scope="row">{{ $pazepro->id }}</th>
                                            <td> {{ $pazepro->last_name }}, {{ $pazepro->first_name }} {{ $pazepro->middle_name }}</td>
                                            <td>{{ $pazepro->account_number }}</td>
                                            <td>{{ $pazepro->email_address }}</td>
                                            <td>{{ $pazepro->mobile_number }}</td>
                                            <td>{{ $pazepro->points }}</td>
                                            <td>{{ $pazepro->created_at }}</td>

                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="align-left">
                                                    <h5>List of Rewards <span>10</span></h5>
                                                </div>
                                            </div>
                                            <div class="col-lg-8">
                                            ...
                                            <div class="blog-post">
                                                <div class="friend-info">
                                                    ...
                                                    <div class="friend-name">
                                                        ...
                                                        <ins><a title="" href="{{route('frontend.rewards.details',[$reward->id])}}">ADMIN</a></ins>
                                                        <span><i class="fa fa-globe"></i> {{ date('Y-m-d',strtotime($reward->created_at)) }} |  <span><a href="" title="">{{$reward->quantity}} Slots</a></span> </span>
                                                    </div>
                                                    <div class="post-meta">
                                                        <figure>
                                                            <a title="" href="{{route('frontend.rewards.details',[$reward->id])}}">
                                                                <img alt="" src="{{asset('uploads/images/'.$reward->file_name)}}">  
                                                            </a>
                                                        
                                                        </figure>                                               
                                                        <div class="description">
                                                            <a data-ripple="" class="learnmore text-uppercase" href="{{route('frontend.rewards.details',[$reward->id])}}">{{$reward->status == 'active' ? 'Available' : 'Not Available'}}</a>
                                                            <div class="row">
                                                                <div class="col-md-9">
                                                                     <h3><a class="oswald-400" href="{{route('frontend.rewards.details',[$reward->id])}}" title="">{{Str::ucfirst($reward->title)}}</a></h3>
                                                                        
                                                                </div>
                                                                 <div class="col-md-3 mt-1">
                                                                     <h5 class="oswald-300" style="color: #FA6342"><a href="{{route('frontend.rewards.details',[$reward->id])}}" title="">{{$reward->amount}} Points</a></h5>
                                                                </div>

                                        ...
                                        <div class="event-box">
                                            <div class="row merged20">
                                                <div class="col-lg-4 col-sm-12">
                                                    <a href="{{route('frontend.pazepro.details_training',[$pazepro->uuid,$item->uuid])}}">
                                                ...
                                                <div class="col-lg-6 col-sm-9">
                                                    <a href="{{route('frontend.pazepro.details_training')}}">
                                                        <div class="event-title">
                                                            <span><i class="fa fa-map-marker"></i> {{ $item->address }}</span>
                                                            <h4>
                                                                <a href="{{route('frontend.pazepro.details_training')}}" title="Boxing with the Pe ople’s Champ - Manny Pacman">{{ $item->title }} | <strong>{{Helper::get_category($item->category) }}</strong></a>
                                                            </h4>

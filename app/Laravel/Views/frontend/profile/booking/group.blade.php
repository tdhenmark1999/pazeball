                    ...
                    <div class="central-meta item">
                        <div class="classic-post">
                                ...
                                <div class="row">
                                    ...
                                    <a href="{{route('frontend.booking.group')}}">
                                    ...
                                    <div class="col-lg-10">
                                    <a href="{{route('frontend.booking.details')}}">
                                        <h4 class="oswald-600">JOHN CENA - 1,000.00 <img style="height: 25px;margin-top: -5px" src="{{asset('frontend/images/points.png')}}"></h4>
                                        <span class="roboto-400">Type of Appointment: Online </span><br />
                                        <span>Link of google meet or zoom</span>
                                        <p class="roboto-400"><i class="fa fa-clock"></i> Jan,12 2020 @3:00PM</p>
                                        <div>
                                            <a class="main-btn bg-success pointer-events--none">Completed</a>
                                        </div>
</a>
                                    </div>
                                </div>
                        ...
                        <div class="classic-post">
                            <div class="row">
                                <div class="col-lg-2 text-center">
                                    <figure>
                                        <img style="width: 100%; height: auto; border-radius: 50%;" src="{{asset('frontend/images/resources/thumb-2.jpg')}}" alt="" />
                                        <span style="margin-top: 10px; font-weight: bold;">PAZEPRO</span>
                                    </figure>
                                </div>
                                <div class="col-lg-10">
                                    <h4 class="oswald-600">UNDERTAKER - 1,000.00 <img style="height: 25px;margin-top: -5px" src="{{asset('frontend/images/points.png')}}"></h4>
                                    <span class="roboto-400">Type of Appointment: Online </span><br />
                                    <span>Link of google meet or zoom</span>
                                    <p class="roboto-400"><i class="fa fa-clock"></i> Jan,12 2020 @3:00PM</p>
                                    <div>
                                        <a class="main-btn bg-warning pointer-events--none">Pending</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="classic-post">
                            <div class="row">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <p class="roboto-400"><i class="fa fa-clock"></i> Jan,12 2020 @3:00PM</p>
                                    <div>
                                        <a class="main-btn3 pointer-events--none">Ongoing</a>
                                    </div>
                                </div>
                            </div>
                        </div>

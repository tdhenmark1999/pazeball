                                ...
                                <div class="central-meta">
                                    <div class="row merged5">
                                        ...
                                        <div class="col-lg-4 col-md-3 col-sm-6 col-xs-6">
                                            <a href="{{route('frontend.profile.video_details',[$my_profile->uuid,$item->uuid])}}">
                                                <div class="item-box">
                                                    ...
                                                    <div class="over-photo">
                                                        <a href="{{route('frontend.profile.video_details',[$my_profile->uuid,$item->uuid])}}" title=""><i class="fa fa-heart"></i> 0</a>
                                                        <span>0 Views</span>
                                                    </div>
                                                </div>
                                            </a>

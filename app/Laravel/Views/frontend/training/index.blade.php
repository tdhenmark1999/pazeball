                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="align-left">
                                                    <h5>List of Trainings <span>{{ $training_count }}</span></h5>
                                                </div>
                                            </div>
                                            <div class="col-lg-8">
                                            ...
                                            <div class="blog-post">
                                                <div class="friend-info">
                                                    ...
                                                    <div class="friend-name">
                                                        ...
                                                        <ins><a title="" href="{{route('frontend.training.show',[$training->uuid])}}">{{ Helper::get_user($training->user_id) }}</a></ins>
                                                        <span><i class="fa fa-globe"></i> {{ $training->created_at }} |  <span><a href="" title="">{{ Helper::get_category($training->category) }}</a></span> </span>
                                                    </div>
                                                    <div class="post-meta">
                                                        <figure>
                                                            <a title="" href="{{route('frontend.training.show',[$training->uuid])}}">
                                                                <img alt="" src="{{asset('uploads/images/'.$training->file_name)}}">  
                                                            </a>
                                                        
                                                        </figure>                                               
                                                        <div class="description">
                                                            <a data-ripple="" class="learnmore text-uppercase" href="{{route('frontend.training.show')}}">{{ $training->status }}</a>
                                                            <div class="row">
                                                                <div class="col-md-9">
                                                                     <h3><a class="oswald-400" href="{{route('frontend.training.show')}}" title="">{{ $training->title }}</a></h3>
                                                                        
                                                                </div>
                                                                 <div class="col-md-3 mt-1">
                                                                     <h5 class="oswald-300" style="color: #FA6342"><a href="{{route('frontend.training.show',[$training->uuid])}}" title="">{{ $training->amount }}</a></h5>
                                                                </div>

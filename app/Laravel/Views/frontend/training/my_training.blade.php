                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="align-left">
                                                    <h5>List of My Trainings <span>1</span></h5>
                                                </div>
                                            </div>
                                            <div class="col-lg-8">
                                                ...
                                                <div class="friend-info">
                                                    ...
                                                    <div class="friend-name">
                                                     {{--    <div class="more">
                                                        ...
                                                        <ins><a title="" href="{{route('frontend.training.show')}}">Sample title</a></ins>
                                                        <span><i class="fa fa-globe"></i> Dhen Mark  |  <span><a href="" title="">Basketball</a></span> </span>
                                                    </div>
                                                    <div class="post-meta">
                                                        <figure>
                                                            <a title="" href="{{route('frontend.training.show')}}">
                                                                <img alt="" src="{{asset('frontend/images/resources/blogpost-2.jpg')}}">  
                                                            </a>
                                                        
                                                        </figure>                                               
                                                        <div class="description">
                                                            <a data-ripple="" class="learnmore text-uppercase" href="{{route('frontend.training.show')}}">Pending</a>
                                                            <div class="row">
                                                                <div class="col-md-9">
                                                                     <h3><a class="oswald-400" href="{{route('frontend.training.show')}}" title="">lorem ipsum</a></h3>
                                                                        
                                                                </div>
                                                                 <div class="col-md-3 mt-1">
                                                                     <h5 class="oswald-300" style="color: #FA6342"><a href="{{route('frontend.training.show')}}" title="">2,000.00</a></h5>
                                                                </div>
                                                              
                                                               
                                                            </div>
                                                            <p>
                                                               Lorem ipsum dummy tet
                                                            </p>
                                                        </div>
